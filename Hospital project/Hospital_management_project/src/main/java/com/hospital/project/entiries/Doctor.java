...
public class Doctor {
	...
	public Doctor(String doctor_name, String user_email, String doctor_contact, String qualifications, String password,
			Login login, byte[] picture, int dept_id) {
		super();
	...
	public Doctor(int doctor_id, String doctor_name, String user_email, String doctor_contact, String qualifications,
	...
	public String toString() {
		return "Doctor [doctor_id=" + doctor_id + ", doctor_name=" + doctor_name + ", user_email=" + user_email
				+ ", doctor_contact=" + doctor_contact + ", qualifications=" + qualifications + ", password=" + password
				+ ", login=" + login + ", picture=" + Arrays.toString(picture) + "]";
	}
